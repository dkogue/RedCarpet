 ...
 * {@link EventImage.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link EventImage#newInstance} factory method to
 * create an instance of this fragment.
 */
public class EventImage extends Fragment implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            btn_imageupload = (Button) getView().findViewById(R.id.eventimagedone);
            eventimage = (ImageView) getView().findViewById(R.id.eventimage);
        }
    }
