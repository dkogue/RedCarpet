...
public class EditEventFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceStates) {
        ...
        current_clicked_event = eventName+"_"+current_event[2];
                ...
                new AlertDialog.Builder(getActivity())
                        ...
                        .setPositiveButton("Delete", new DialogInterface.OnClickListener()
                        {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                removeFromFirebase(current_event[1],current_event[7], current_clicked_event);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()) {
            ...
            case R.id.button13:
                ...
                EventUtil.saveEventToFirebase(editedEvent);
                EventUtil.saveEventForSpecificUser(uid,editedEvent);
    ...
    public void removeFromFirebase(String eventName,String type, String eventName_Date){
        FirebaseDatabase database;
        DatabaseReference myRef;
        ...
        myRef = myRef.child(eventName_Date);
        myRef.removeValue();
